          ...
          <div className="w-full h-full bg-muted/30 rounded-md flex flex-col items-center justify-center">
            {isStreaming ? (
              <div className="text-center space-y-4">
                ...
                <p className="text-base text-muted-foreground">Connecting to digital human...</p>
              </div>
            ) : (
              <div className="text-center space-y-4">
                ...
                <p className="text-xl font-medium">Digital Human</p>
                <p className="text-base text-muted-foreground">Start a conversation to activate</p>
              </div>
            )}
          </div>
        )}
